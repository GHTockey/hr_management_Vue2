...
export default {
  ...
  created() {
    this.currentMonth = this.startDate.getMonth() + 1; // 月
    this.currentYear = this.startDate.getFullYear(); // 年
    this.yearList = Array.from(Array(11), (val, ind) => {
      return this.currentYear + ind - 5;
    });
    this.dateChange();
  },
  methods: {
